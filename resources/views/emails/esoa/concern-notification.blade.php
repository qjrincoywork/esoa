...
@section('content')
  ...
  <p>
    A concern was saved in ESOA by {{ $concern->user?->name ?? $concern->user?->email ?? 'an authenticated user' }}.
  </p>
  ...
  <p>
    This notification was sent to {{ config('vc.contact_email') }} and copied to the concern creator.
  </p>
