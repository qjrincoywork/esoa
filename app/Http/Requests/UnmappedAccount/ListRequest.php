...
class ListRequest extends FormRequest
{
    ...
    public function lookupParams(): array
    {
        ...
        if ($this->scope() === AccountDirectoryScope::BRANCH) {
            return $params + [
                'assigned_branch_codes' => UserAccount::assignedBranchCodes(),
                'accounts_mapped_in_full' => UserAccount::accountCodesMappedInFull(),
            ];
        }

        return $params + [
            'assigned_account_codes' => UserAccount::assignedAccountCodes(),
        ];
    }
