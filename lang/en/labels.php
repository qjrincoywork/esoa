...
return [
    ...
    'billing_invoice_due_reminder' => [
        'subject' => 'Billing Invoice Due Reminder - :aging (:count items)',
        'greeting' => 'Dear Valued Customer,',
        'intro' => 'This email is to notify you that you have :count billing invoice(s) that are :aging.',
        'summary' => ':count billing invoice(s) in this category.',
        'view_list' => 'View billing invoices',
        'warning' => 'Important Notice',
        'warning_text' => 'Please ensure timely payment to avoid potential service disruption. If payment has already been made, please disregard this notice.',
        'action_text' => 'Use the button above to open your filtered billing invoice list, or log in to the eSOA customer portal. Contact our billing department if you need assistance.',
        'closing' => 'Thank you for your attention to this matter. For any concerns, please reach out to our billing department.',
    ],
